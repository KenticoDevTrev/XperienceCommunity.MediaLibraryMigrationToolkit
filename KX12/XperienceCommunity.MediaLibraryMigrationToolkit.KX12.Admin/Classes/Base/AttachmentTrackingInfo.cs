...
namespace MediaLibraryMigrationToolkit
{
    ...
    /// </summary>
    [Serializable]
    public partial class AttachmentTrackingInfo : AbstractInfo<AttachmentTrackingInfo>
    {
        /// <summary>
        /// Object type.
        /// </summary>
        ...
        {
            AttachmentTrackingInfoProvider.DeleteAttachmentTrackingInfo(this);
        }
        ...
        {
            AttachmentTrackingInfoProvider.SetAttachmentTrackingInfo(this);
        }
