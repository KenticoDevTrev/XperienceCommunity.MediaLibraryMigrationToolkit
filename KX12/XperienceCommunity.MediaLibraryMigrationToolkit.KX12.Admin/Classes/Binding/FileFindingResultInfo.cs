...
namespace MediaLibraryMigrationToolkit
{
    ...
    public partial class FileFindingResultInfo : AbstractInfo<FileFindingResultInfo>
    {
        ...
        public static readonly ObjectTypeInfo TYPEINFO = new ObjectTypeInfo(typeof(FileFindingResultInfoProvider), OBJECT_TYPE, "MediaLibraryMigrationToolkit.FileFindingResult", "FileFindingResultID", "FileFindingResultLastModified", "FileFindingResultGuid", null, null, null, null, null, null)
        {
            ...
            {
                new ObjectDependency("FileFindingResultFileTrackingID", "medialibrarymigrationtoolkit.filetracking", ObjectDependencyEnum.Required),
        ...
        /// <summary>
        /// File finding result file tracking ID.
        /// </summary>
        [DatabaseField]
        public virtual int FileFindingResultFileTrackingID
        {
            get
            {
                return ValidationHelper.GetInteger(GetValue("FileFindingResultFileTrackingID"), 0);
            }
            set
            {
                SetValue("FileFindingResultFileTrackingID", value);
            }
        }
